...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','PLY_TEST.py',33),
  ('expr -> expr MINUS term','expr',3,'p_expr','PLY_TEST.py',34),
  ('expr -> term','expr',1,'p_expr_term','PLY_TEST.py',44),
  ('term -> term TIMES factor','term',3,'p_term','PLY_TEST.py',51),
  ('term -> term DIVIDE factor','term',3,'p_term','PLY_TEST.py',52),
  ('term -> factor','term',1,'p_term_factor','PLY_TEST.py',61),
  ('factor -> NUM','factor',1,'p_factor','PLY_TEST.py',67),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','PLY_TEST.py',73),
]
